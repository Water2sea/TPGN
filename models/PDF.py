...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len: Optional[int] = 1024, d_k: Optional[int] = None, d_v: Optional[int] = None,
        ...
        kernel_list = configs.PDF_kernel_list
        patch_len = configs.PDF_patch_len
        period = configs.PDF_period
        stride = configs.PDF_stride
    ...
    def forward(self, x, a, b, c):  # x: [Batch, Input length, Channel]
