...
from layers.micn_local_global import Seasonal_Prediction, series_decomp_multi
...
class MICN(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        x_mark_dec_input = torch.cat([x_mark_enc, x_mark_dec], dim=1)
        dec_out = self.dec_embedding(seasonal_init_dec, x_mark_dec_input)
